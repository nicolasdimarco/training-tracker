...
urlpatterns = [
    ...
    path('routine/delete/<int:pk>/', routine_views.routine_delete, name='routine_delete'),
    ...
    path('routine/<int:routine_pk>/instruction/delete/<int:instruction_pk>', routine_views.routine_instruction_delete,
         name='routine_instruction_delete'),
